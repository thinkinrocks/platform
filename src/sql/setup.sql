...
CREATE TABLE IF NOT EXISTS users (
    login TEXT(32) NOT NULL PRIMARY KEY UNIQUE,
    username TEXT(32) NOT NULL,
    salt TEXT(32) NOT NULL,
    password_hash TEXT(88) NOT NULL,
    sire TEXT(32),
    FOREIGN KEY (sire) REFERENCES users (login)
);
...
CREATE TABLE IF NOT EXISTS entries (
    ...
    FOREIGN KEY (responsible_person) REFERENCES users (login) ON DELETE SET NULL
);